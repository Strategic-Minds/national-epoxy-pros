...
export const metadata: Metadata = { title: 'Decorative Flake Floors', description: 'Durable, chip-broadcast vinyl flake systems with unmatched slip resistance and easy maintenance. The most popular choice for garages, basements, and commercial spaces.' };
    ...
    <main>
      <section style={{background:'var(--black)',color:'var(--white)',padding:'80px 24px'}}>
        <div style={{maxWidth:'var(--container)',margin:'0 auto',display:'grid',gridTemplateColumns:'1fr 380px',gap:48,alignItems:'center'}}>
          <div>
            <span className="eyebrow">Decorative Flake Floors</span>
            <h1 className="display" style={{fontSize:'clamp(36px,5vw,64px)',color:'var(--white)',marginBottom:16}}>DECORATIVE FLAKE. BUILT TO IMPRESS.</h1>
            <p style={{fontSize:17,color:'#aaa',marginBottom:32,maxWidth:520}}>Durable, chip-broadcast vinyl flake systems with unmatched slip resistance and easy maintenance. The most popular choice for garages, basements, and commercial spaces.</p>
      ...
      <section className="section"><div className="container">
        <div className="section-header"><span className="eyebrow">Benefits</span><h2>WHY CHOOSE DECORATIVE FLAKE FLOORS?</h2></div>
