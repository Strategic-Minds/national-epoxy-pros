    ...
    <main>
      <div style={{background:'#0A0A0A',padding:'56px 0'}}>
        <div className="container">
          ...
          <h1 className="display-md" style={{color:'#fff'}}>POLISHED CONCRETE</h1>
          <p style={{color:'#9CA3AF',marginTop:12,maxWidth:560,fontSize:15}}>
            Professional-grade Polished Concrete system — full specification, competitive bid, certified installation.
          </p>
        </div>
      </div>
