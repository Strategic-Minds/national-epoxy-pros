...
export const metadata: Metadata = { title: 'Quartz Flooring Systems', description: 'Decorative quartz broadcast systems delivering superior aesthetics, chemical resistance, and slip resistance for any commercial or residential application.' };
    ...
    <main>
      <section style={{background:'var(--black)',color:'var(--white)',padding:'80px 24px'}}>
        <div style={{maxWidth:'var(--container)',margin:'0 auto',display:'grid',gridTemplateColumns:'1fr 380px',gap:48,alignItems:'center'}}>
          <div>
            <span className="eyebrow">Quartz Flooring Systems</span>
            <h1 className="display" style={{fontSize:'clamp(36px,5vw,64px)',color:'var(--white)',marginBottom:16}}>QUARTZ FLOORING. EXTRAORDINARY RESULTS.</h1>
            <p style={{fontSize:17,color:'#aaa',marginBottom:32,maxWidth:520}}>Decorative quartz broadcast systems delivering superior aesthetics, chemical resistance, and slip resistance for any commercial or residential application.</p>
      ...
      <section className="section"><div className="container">
        <div className="section-header"><span className="eyebrow">Benefits</span><h2>WHY CHOOSE QUARTZ FLOORING SYSTEMS?</h2></div>
